...
- User Login Credentials: (Arun/Arun)
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```[https://github.com/shashirajraja/onlinebookstore.git](https://github.com/Ashishchinnu/OnlineBookstore)```> Select master Branch > Next > Next > Finish.
...
Step 8: The default Username And Password For User Is "Arun" And "Arun"
